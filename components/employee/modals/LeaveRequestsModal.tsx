...
export default function LeaveRequestsModal({ context }: { context: Record<string, any> }) {
  const { cancelLeave, countLeaveDays, myLeaves, myLeavesModalOpen, selectedMyLeaveDetail, setLeaveChoiceModalOpen, setMyLeavesModalOpen, setSelectedMyLeaveDetail } = context;
  return (
    <>
